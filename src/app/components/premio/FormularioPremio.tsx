...
export default function FormalarioPremio(props: FormularioPremioProps) {
    ...
    const [colabP, setColabP] = useState<ColaboradorPremio[]>(props.registro.ColaboradorPremio || []);
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            {Array.isArray(colabP) && colabP?.length > 0 && (
                <ListaColaborador colaboradoresPremio={colabP} onClick={props.excluirColaborador} onHandleClickDelete={handleClickDelete}/>
            )}
        </div >
    )
}